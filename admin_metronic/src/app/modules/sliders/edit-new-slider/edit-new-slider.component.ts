...
export class EditNewSliderComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.imagen_previsualizacion = URL_BACKEND + 'api/sliders/uploads/slider/' + this.slider_selected.imagen;
  ...
  save() {
    console.log(this.name, this.imagen_file, this.link,this.state);
