...
export class ListProductsComponent implements OnInit {
  ...
  loadServices() {
    ...
    setTimeout(() => { this._productService.isLoadingSubject.next(false); }, 50);
  }
  allProducts() {
    this._productService.allProducts(this.search, this.categorie).subscribe((resp: any) => { console.log(resp); this.products = resp.products; })
  }
  refresh() {
    this.categorie = '';
    this.search = null;
  ...
  editProduct(product) {//COMPROBAR SI LA FUNCION EN HTML ES IGUAL OJO!!!!!
